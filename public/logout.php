<?php require_once __DIR__.'/../app/helpers.php'; session_unset(); session_destroy(); header('Location:/login.php'); exit;```
...
<main class="container">
    ...
    <div class="grid">
        <?php foreach($dest as $d): ?>
            <article class="card">
                <img src="/assets/images/<?= e($d['image'] ?? 'placeholder.jpg') ?>" alt="<?= e($d['title']) ?>">
                <h3><?= e($d['title']) ?></h3>
